...
@Repository //Encapsula almacenamiento, rcuperación y busqueda de objetos
public class LibroRepository {

    //Array para guardar todos los libros 
    ...
    //Metodo para guardar el libro y retornarlo
    public Libro guardar(Libro lib) {
        listaLibros.add(lib);
        return lib;
    }

    //Actualiza el libro por ID y lo retorna
    public Libro actulizar(Libro lib) {
        int id = 0;
        int idPosicion = 0;
